  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const railwayRoutesResponse = await fetch(`${trainRouteURL}/railwayRoutes`);
        ...
        const stationsResponse = await fetch(`${trainRouteURL}/Stations`);
    ...
    if (startStation && endStation) {
      try {
        const response = await fetch(
          `${trainRouteURL}/railwayRoutesByStations?startStation=${startStation}&endStation=${endStation}`
        );
